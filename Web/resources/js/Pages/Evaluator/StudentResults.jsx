    ...
    useEffect(() => {
        const timeoutId = setTimeout(() => {
            router.get('/evaluator/student-results', {
                student_name: searchTerm || null
            }, {
                preserveState: true,
                replace: true,
                only: ['recommendations', 'stats', 'personalityDistribution', 'filters']
            });
        }, 400); // 400ms debounce
        ...
        <>
            ...
            <Layout user={user} routes={[]}>
                <div className="max-w-7xl mx-auto animate-up" style={{ animationDelay: '60ms' }}>
                    ...
                    {/* Live Search Section */}
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/80 mb-8 animate-fadeIn">
                        <div className="p-6">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-lg font-semibold text-[#1D293D] mb-0.5">Search Students</h2>
                                    <p className="text-sm text-slate-500">Type to search by student name (live search)</p>
                                </div>
                                <div className="text-sm text-slate-600">
                                    <span className="font-semibold text-[#1447E6]">{safeRecommendations.data?.length || 0}</span> results
                                </div>
                            </div>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-12 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1447E6]/20 focus:border-[#1447E6] transition-all bg-white text-[#1D293D] placeholder-slate-400"
