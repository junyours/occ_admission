...
<body>
  ...
  <div class="exam-header">
    <div class="header-logos">
      ...
      <div>
        @if($deptLogo)
          <img src="{{ $deptLogo }}" alt="Department Logo" class="dept-logo">
        @endif
      </div>
    </div>
  </div>
        ...
        <div class="options">
          <div class="option">
            ...
            @if($question['has_option_images']['option1'] && $question['option1_image'])
              <div class="option-image">
                <img src="{{ $question['option1_image'] }}" alt="Option A">
              </div>
            @endif
          </div>
          ...
          <div class="option">
            ...
            @if($question['has_option_images']['option2'] && $question['option2_image'])
              <div class="option-image">
                <img src="{{ $question['option2_image'] }}" alt="Option B">
              </div>
            @endif
          </div>
          ...
          <div class="option">
            ...
            @if($question['has_option_images']['option3'] && $question['option3_image'])
              <div class="option-image">
                <img src="{{ $question['option3_image'] }}" alt="Option C">
              </div>
            @endif
          </div>
          ...
          <div class="option">
            ...
            @if($question['has_option_images']['option4'] && $question['option4_image'])
              <div class="option-image">
                <img src="{{ $question['option4_image'] }}" alt="Option D">
              </div>
            @endif
          </div>
          ...
          @if($question['option5'])
            <div class="option">
              ...
              @if($question['has_option_images']['option5'] && $question['option5_image'])
                <div class="option-image">
                  <img src="{{ $question['option5_image'] }}" alt="Option E">
                </div>
              @endif
            </div>
          @endif
